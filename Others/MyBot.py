...
# Chave de API (armazene em uma variável de ambiente para segurança)
V_API_KEY = os.getenv("GROQ_API_KEY")  # Configure no ambiente
os.environ['GROQ_API_KEY'] = V_API_KEY
